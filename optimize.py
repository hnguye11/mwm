...
X = READ_CSV_FILE("X_campus5_99.csv")
assert(len(X[0]) == M)
...
print("EG_UNIQUE =", EG_UNIQUE)
print("gp = [%s]"%TO_STRING(gp, format="%.4e"))
print("BUDGET = [%.1f, %.1f]"%(BUDGET_MIN, BUDGET_MAX))
